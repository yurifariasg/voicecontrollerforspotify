...
public class SettingContent {
    ...
    static {
        ...
        addItem(new SettingItem(Settings.ID.SIMILARITY_PERCENTAGE, R.string.similarity_percentage, R.string.similarity_percentage_desc, new String[] {"70%", "80%", "90%", "40%", "50%", "60%"}));
    }
